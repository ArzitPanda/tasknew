...
const Header = () => {
  ...
  return (
    <div className={`${darkMode ? 'bg-slate-950' : 'bg-white'} h-10 w-full flex items-center justify-between py-5 fixed top-0 z-50 mb-16 border-b-[1px] border-gray-200`}>
      ...
      <div className="flex items-center justify-center gap-4 mx-12">
        ...
        style={{backgroundColor:'gray',caretColor:'blue'}}
          ...
          unCheckedChildren={<MdOutlineLightMode size={24}   style={{ fill: '#FFFFFF', width: '20px', height: '24px',textAlign:'center' }}/>}
        />
      </div>
    </div>
  );
